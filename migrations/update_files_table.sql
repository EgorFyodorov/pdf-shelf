...
-- Все данные анализа хранятся в analysis_json, отдельные поля reading_time_min и tags для производительности
...
-- - tags (TEXT[]) вынесено в отдельное поле для быстрой фильтрации по тегам
-- - Все остальные данные (complexity, полная информация о topics, category, volume) хранятся в analysis_json
-- - GIN-индексы на tags и analysis_json позволяют эффективно искать по тегам и другим полям
